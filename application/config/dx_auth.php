...
$config['DX_webmaster_email'] = 'akim.bb@mai.ru';
...
// Forms view
$config['DX_login_view'] = 'front/auth/login_form';
$config['DX_register_view'] = 'front/auth/register_form';
$config['DX_forgot_password_view'] = 'front/auth/forgot_password_form';
$config['DX_change_password_view'] = 'front/auth/change_password_form';
$config['DX_cancel_account_view'] = 'front/auth/cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'front/auth/general_message';
$config['DX_banned_view'] = 'front/auth/general_message';
$config['DX_logged_in_view'] = 'front/auth/general_message';
$config['DX_logout_view'] = 'front/auth/general_message';

$config['DX_register_success_view'] = 'front/auth/general_message';
$config['DX_activate_success_view'] = 'front/auth/general_message';
$config['DX_forgot_password_success_view'] = 'front/auth/general_message';
$config['DX_reset_password_success_view'] = 'front/auth/general_message';
$config['DX_change_password_success_view'] = 'front/auth/general_message';

$config['DX_register_disabled_view'] = 'front/auth/general_message';
$config['DX_activate_failed_view'] = 'front/auth/general_message';
$config['DX_reset_password_failed_view'] = 'front/auth/general_message';
