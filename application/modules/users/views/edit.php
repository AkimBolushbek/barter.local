...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input required name='username' value="<?= $entry['username'] ?>" type="text" class="form-control" id="username">
        </div>
        <div class="form-group">
            <label for="name">Имя</label>
            <input required name='first_name' value="<?= $entry['first_name'] ?>" type="text" class="form-control" id="first_name" >
        </div>
        <div class="form-group">
            <label for="last_name">Фамилия</label>
            <input required name='last_name' value="<?= $entry['last_name'] ?>" type="text" class="form-control" id="last_name">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input required name='company' value="<?= $entry['company'] ?>" type="text" class="form-control" id="company">
        </div>
    </div>
</div>
