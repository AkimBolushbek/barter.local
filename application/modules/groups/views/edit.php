...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input required name='name'  value="<?= $entry['name'] ?>"  type="text" class="form-control" id="name">
        </div>
        <div class="form-group">
            <label for="name">Описание</label>
            <textarea required name='description'   class="form-control" rows="5" id="description"><?= $entry['description'] ?></textarea>
        </div>
    </div>
</div>
